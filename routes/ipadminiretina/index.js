...
module.exports = function (app) {
    app.get('/ipad-mini-retina', validateParams, getAvailability, render);
};

var devices = models['ipad-mini-retina'];
...
var render = function(req, res) {
    ...
    modelInfo.title = 'iPad mini Retina display Availability - Apple-Tracker.com';
    modelInfo.share = share;
    modelInfo.appleItemUrl = 'http://store.apple.com/us/buy-ipad/ipad-mini-retina';
    res.render('ipad-mini-retina', modelInfo);
